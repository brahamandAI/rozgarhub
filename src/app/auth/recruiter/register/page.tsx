        ...
        <div className="p-8 md:p-12 flex flex-col justify-center">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex mb-6 items-center justify-between">
              <div 
                className={`w-1/3 text-center py-2 text-xs font-medium rounded-l-md ${activeSection === 1 ? 'bg-purple-600 text-white' : 'bg-slate-700 text-slate-400'}`}
              >
                Personal
              </div>
              <div 
                className={`w-1/3 text-center py-2 text-xs font-medium ${activeSection === 2 ? 'bg-purple-600 text-white' : 'bg-slate-700 text-slate-400'}`}
              >
                Company
              </div>
              <div 
                className={`w-1/3 text-center py-2 text-xs font-medium rounded-r-md ${activeSection === 3 ? 'bg-purple-600 text-white' : 'bg-slate-700 text-slate-400'}`}
              >
                Address
              </div>
            </div>
            ...
            {activeSection === 1 && (
              <div className="space-y-4">
                <h2 className="font-semibold text-lg text-white mb-3">👤 Personal Details</h2>
            ...
            {activeSection === 2 && (
              <div className="space-y-4">
                <h2 className="font-semibold text-lg text-white mb-3">🏢 Company Details</h2>
                ...
                <div>
                  <label htmlFor="companyWebsite" className="block text-sm font-medium text-slate-300 mb-1">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`w-full pl-10 pr-4 py-2.5 bg-slate-700 border ${companyWebsiteError ? 'border-red-500' : 'border-slate-600'} rounded-md focus:ring-2 focus:ring-purple-500 focus:border-purple-500 outline-none transition-colors`}
                ...
                <div>
                  <label htmlFor="companyIndustry" className="block text-sm font-medium text-slate-300 mb-1">
                    Company Industry
                  </label>
                  <select
                    id="companyIndustry"
                ...
                <div>
                  <label htmlFor="companySize" className="block text-sm font-medium text-slate-300 mb-1">
                    Company Size
                  </label>
                  <select
                    id="companySize"
                ...
                <div>
                  <label htmlFor="companyLogo" className="block text-sm font-medium text-slate-300 mb-1">
                ...
                <div>
                  <label htmlFor="companyDescription" className="block text-sm font-medium text-slate-300 mb-1">
                    Company Description
                  </label>
                  <div className="relative">
                    <textarea
            ...
            {activeSection === 3 && (
              <div className="space-y-4">
                <h2 className="font-semibold text-lg text-white mb-3">📍 Company Address</h2>
                
                <div>
                  <label htmlFor="addressLine" className="block text-sm font-medium text-slate-300 mb-1">
                    Address Line
                  </label>
                  <div className="relative">
