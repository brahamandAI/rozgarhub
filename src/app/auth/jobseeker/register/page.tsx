...
export default function JobSeekerRegisterPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-900 text-white flex items-center justify-center p-4 pt-24 pb-16">
      <div className="grid md:grid-cols-2 gap-0 max-w-4xl w-full bg-slate-800 shadow-2xl rounded-lg overflow-hidden">
        ...
        <div className="p-8 md:p-12 flex flex-col justify-center">
          <div className="mb-8">
            <h1 className="text-3xl font-bold mb-2 text-white">Create Job Seeker Account</h1>
            <p className="text-slate-400 text-sm">
              Join RozgarHub to find your dream job.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex mb-6 items-center justify-between">
              <div 
                className={`w-1/2 text-center py-2 text-xs font-medium rounded-l-md ${activeSection === 1 ? 'bg-purple-600 text-white' : 'bg-slate-700 text-slate-400'}`}
              >
                Personal Details
              </div>
              <div 
                className={`w-1/2 text-center py-2 text-xs font-medium rounded-r-md ${activeSection === 2 ? 'bg-purple-600 text-white' : 'bg-slate-700 text-slate-400'}`}
              >
                Professional Details
              </div>
            </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      required
                      className={`w-full pl-10 pr-4 py-2.5 bg-slate-700 border ${emailError ? 'border-red-500' : 'border-slate-600'} rounded-md focus:ring-2 focus:ring-purple-500 focus:border-purple-500 outline-none transition-colors`}
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      required
                      className={`w-full pl-10 pr-10 py-2.5 bg-slate-700 border ${passwordError ? 'border-red-500' : 'border-slate-600'} rounded-md focus:ring-2 focus:ring-purple-500 focus:border-purple-500 outline-none transition-colors`}
            ...
            {activeSection === 2 && (
              <div className="space-y-4">
                <div>
                  <label htmlFor="currentJobTitle" className="block text-sm font-medium text-slate-300 mb-1">
                    Current Job Title
                  </label>
                  <div className="relative">
                ...
                <div>
                  <label htmlFor="yearsOfExperience" className="block text-sm font-medium text-slate-300 mb-1">
                    Years of Experience
                  </label>
                  <div className="relative">
                ...
                <div>
                  <label htmlFor="education" className="block text-sm font-medium text-slate-300 mb-1">
                    Education
                  </label>
                  <div className="relative">
                ...
                <div>
                  ...
                  <div className="flex gap-2">
                    ...
                    <button
                      ...
                      className="px-4 py-2.5 bg-purple-600 text-white rounded-md hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 focus:ring-offset-slate-800"
                    >
                      Add
                    </button>
                  </div>
                ...
                <div>
                  <label htmlFor="resume" className="block text-sm font-medium text-slate-300 mb-1">
                    ...
                    className="w-full px-4 py-2 bg-slate-700 border border-slate-600 rounded-md focus:ring-2 focus:ring-purple-500 focus:border-purple-500 outline-none transition-colors text-sm text-slate-300"
                  />
                </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`w-full pl-10 pr-4 py-2.5 bg-slate-700 border ${linkedinUrlError ? 'border-red-500' : 'border-slate-600'} rounded-md focus:ring-2 focus:ring-purple-500 focus:border-purple-500 outline-none transition-colors`}
                ...
                <div>
                  <label htmlFor="expectedSalary" className="block text-sm font-medium text-slate-300 mb-1">
                ...
                <div>
                  <label htmlFor="noticePeriod" className="block text-sm font-medium text-slate-300 mb-1">
                    Notice Period (Days)
                  </label>
                  <div className="relative">
                    <Calendar className="absolute left-3 top-1/2 transform -translate-y-1/2 h-4 w-4 text-slate-400" />
                ...
                <button
                  type="button"
                    onClick={prevSection}
                    className="w-1/2 bg-slate-700 text-white font-semibold py-3 px-4 rounded-md hover:bg-slate-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-slate-900 focus:ring-slate-500 transition-colors duration-150"
                  >
                    Back
                </button>
                <button
        ...
        <div className="hidden md:block bg-gradient-to-br from-purple-600 to-purple-800 p-8 md:p-12">
          <div className="max-w-sm mx-auto">
            <h2 className="text-2xl font-bold text-white mb-6">Why Join RozgarHub?</h2>
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  <h3 className="text-lg font-medium text-white">Find Your Dream Job</h3>
              ...
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  <h3 className="text-lg font-medium text-white">Connect with Employers</h3>
                  <p className="mt-1 text-purple-100">
