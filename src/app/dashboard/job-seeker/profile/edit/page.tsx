              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    disabled
                    className="w-full pl-10 pr-4 py-2.5 bg-slate-700 border border-slate-600 rounded-md cursor-not-allowed"
                  />
                </div>
              </div>
                  ...
                  <div className="flex gap-2">
                    <div className="relative flex-1">
                      <input
                        ...
                        className="w-full pl-4 pr-4 py-2.5 bg-slate-700 border border-slate-600 rounded-md focus:ring-2 focus:ring-purple-500 focus:border-purple-500 outline-none transition-colors"
