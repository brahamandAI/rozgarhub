...
export default function BrowseCandidatesPage() {
  ...
  useEffect(() => {
    ...
    const candidatesDataStr = localStorage.getItem("candidates");
    try {
      if (candidatesDataStr) {
        const allCandidates = JSON.parse(candidatesDataStr);
        setCandidates(allCandidates);
        setFilteredCandidates(allCandidates);
      } else {
        // Initialize empty candidates array
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            <div className="flex items-center justify-between">
              <h1 className="text-3xl font-bold text-white">Browse Candidates</h1>
              <Link 
