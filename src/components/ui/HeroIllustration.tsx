...
export const HeroIllustration = ({ className }: HeroIllustrationProps) => {
  ...
  return (
    <div className={`relative w-full h-full ${className}`}>
      ...
      >
        ...
        <motion.div 
          className={`absolute bottom-[-15%] right-[-10%] w-[55%] h-[55%] rounded-full 
            ${theme === "dark" ? "bg-blue-400/10" : "bg-blue-400/5"} 
            blur-3xl opacity-50 z-0`}
          variants={blobAnimation}
          animate="animate"
      ...
      {/* Dark mode glow effect behind the illustration */}
      {theme === "dark" && (
        <motion.div
      ...
      {/* Interactive elements that overlay the SVG */}
      <motion.div 
